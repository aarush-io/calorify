...
export default function ProgressCard() {
  ...
  return (
    <motion.div
      ...
      className={`glass rounded-3xl p-5 mb-5 relative overflow-hidden ${
        completed ? "glow-success" : "glow-primary"
      }`}
    >
      {/* Background glow */}
      <div
      ...
      <div className="relative z-10 flex items-center gap-5">
        ...
        <div className="flex-1 space-y-4">
          ...
          <div>
            <div className="text-white/40 text-xs uppercase mb-1">Consumed</div>
            <div
              className="calorie-number text-3xl font-bold"
              style={{ color: completed ? "#10B981" : "#A78BFA" }}
            >
          ...
          <div>
            <div className="text-white/40 text-xs uppercase mb-1">Remaining</div>
            <div className="calorie-number text-xl font-semibold text-white/70">
              {remaining.toLocaleString()}
              <span className="text-sm text-white/30 ml-1">{unit}</span>
            </div>
          </div>
